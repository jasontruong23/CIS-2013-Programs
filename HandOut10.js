...
var passwordCheckOld = function () 
{
 ...
 if (stringPassword.length < 5)
    ...
    for (i = 0; i < arrayBadPasswords.length; i++)
   {
      ...
      {
         stringOutput = "Your password is bad, try again";
         break;
      }
      else
      {
         stringOutput = "Your password is safe";
      }
   }
   }
