...
var fixPrinter = function() {
    ...
    if($("yes_printing").selected===false && $("not_printing").selected===false||$("yes_redlight")===false && $("no_redlight").selected===false||$("yes_recognised")===false && $("not_recognised"))
{alert("Not all criteria were selected. To ensure you troubleshoot your printer correctly please ensure all three dropdown boxes are selected.");}
      switch(true) {
